  ...
  return (
    <main className="min-h-screen relative bg-white overflow-hidden">
      ...
      <div className="bg-[#E6F2FF] relative overflow-hidden py-16 md:py-24">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-[20%] right-[20%] w-[450px] h-[450px] bg-[#BE55FF]/15 rounded-full blur-3xl animate-float-medium" style={{ animationDelay: "0.3s" }} />
          <div className="absolute bottom-[20%] left-[20%] w-[400px] h-[400px] bg-[#70BFFF]/18 rounded-full blur-3xl animate-float-slow" style={{ animationDelay: "1s" }} />
        </div>
