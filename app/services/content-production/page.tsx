        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              video and photography that supports your marketing goals and brand
              storytelling.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-700 leading-relaxed text-center mb-12">
              Our monthly content production service delivers a comprehensive
              suite of video and photography services. From cinematic video
              production to professional photography, we handle every aspect of
              content creation to ensure your brand maintains consistent,
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-lg">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-[#BE55FF] mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">
                    Asset organisation and delivery
                  </span>
                </li>
              </ul>
            </div>
            ...
            {[
              {
                ...
                desc: "Monthly planning session to align content needs with your marketing calendar and brand objectives",
              },
              {
                step: 2,
                title: "Pre-Production Planning",
                desc: "Scriptwriting, storyboarding, location scouting, and production scheduling",
              },
              {
                step: 3,
                title: "Production Execution",
                desc: "On-location or studio filming and photography with professional equipment and crew",
              },
              {
                step: 4,
                title: "Post-Production & Editing",
                desc: "Professional editing, colour grading, and enhancement to deliver cinematic quality",
              },
              {
                step: 5,
                title: "Review & Refinement",
                desc: "Client review process with revision rounds to ensure content meets brand standards",
              },
              {
                step: 6,
                title: "Asset Delivery & Organisation",
                desc: "Organised delivery of all final assets in required formats and resolutions",
              },
              {
                step: 7,
                title: "Performance Integration",
                desc: "Content optimised for your platforms and integrated into your marketing workflow",
              },
            ].map((item) => (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="flex items-start gap-3 bg-[#E6F2FF] rounded-2xl p-6"
                >
            ...
            {[
              {
                ...
                desc: "Maintain steady stream of premium content that keeps your brand top-of-mind",
              },
              {
                icon: TrendingUp,
                title: "Scalable Production",
                desc: "Scale content production without hiring internal teams or managing freelancers",
              },
              {
                icon: Palette,
                title: "Professional Quality",
                desc: "Access cinematic production quality that elevates your brand perception",
              },
              {
                icon: CheckCircle2,
                title: "Time Efficiency",
                desc: "Free your team to focus on core business while we handle all production",
              },
              {
                icon: Users,
                title: "Strategic Alignment",
                desc: "Content aligned with your marketing calendar and business objectives",
              },
              {
                icon: Video,
                title: "Multi-Format Delivery",
                desc: "Receive content in all formats needed for your various platforms and channels",
              },
            ].map((benefit, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-3xl p-8 border border-gray-200 shadow-lg hover:shadow-xl transition-all"
                >
      ...
      <div className="bg-white relative overflow-hidden py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-700 mb-8">
            Let's discuss how monthly content production can support your
            brand's visual storytelling needs.
          </p>
