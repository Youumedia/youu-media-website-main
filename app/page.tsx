    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="bg-[#E6F2FF] relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute bottom-[12%] left-[12%] w-24 h-24 bg-gradient-to-br from-[#BE55FF]/25 to-[#70BFFF]/25 rounded-full animate-float-medium"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute top-[35%] right-[35%] w-16 h-16 bg-[#70BFFF]/20 rounded-lg rotate-12 animate-float-fast"
          ...
          />
          <div
            className="absolute top-[65%] right-[20%] w-28 h-28 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-full animate-float-medium"
            style={{ animationDelay: "0.5s" }}
          />
          <div
            className="absolute top-[15%] left-[65%] w-22 h-22 bg-gradient-to-br from-[#BE55FF]/22 to-[#70BFFF]/22 rounded-xl rotate-12 animate-float-fast"
            style={{ animationDelay: "0.8s" }}
          />
          <div
            className="absolute bottom-[18%] right-[15%] w-26 h-26 bg-[#70BFFF]/18 rounded-full animate-float-slow"
            style={{ animationDelay: "1.2s" }}
          />
          <div
            className="absolute top-[45%] left-[8%] w-18 h-18 bg-[#BE55FF]/20 rounded-lg rotate-12 animate-float-medium"
            style={{ animationDelay: "0.3s" }}
          />
          <div
            className="absolute bottom-[40%] right-[40%] w-30 h-30 bg-gradient-to-br from-[#70BFFF]/22 to-[#BE55FF]/22 rounded-full animate-float-fast"
            style={{ animationDelay: "1.7s" }}
          />
          <div
            className="absolute top-[80%] left-[50%] w-24 h-24 bg-[#BE55FF]/18 rounded-xl rotate-45 animate-float-slow"
            style={{ animationDelay: "0.6s" }}
          />
          <div
            className="absolute top-[30%] right-[60%] w-20 h-20 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-2xl rotate-12 animate-float-medium"
            style={{ animationDelay: "1.4s" }}
          />
          <div
            className="absolute bottom-[55%] left-[45%] w-28 h-28 bg-[#BE55FF]/19 rounded-full animate-float-fast"
            style={{ animationDelay: "0.9s" }}
          />
          <div
            className="absolute top-[55%] right-[8%] w-22 h-22 bg-gradient-to-br from-[#70BFFF]/21 to-[#BE55FF]/21 rounded-xl rotate-45 animate-float-slow"
      ...
      <div className="bg-[#E6F2FF] relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          />
          <div
            className="absolute top-[32%] right-[32%] w-16 h-16 bg-[#70BFFF]/20 rounded-lg rotate-12 animate-float-fast"
            style={{ animationDelay: "2s" }}
          />
          <div
            className="absolute bottom-[30%] left-[30%] w-20 h-20 bg-[#BE55FF]/20 rounded-full animate-float-slow"
            style={{ animationDelay: "0.5s" }}
          />
          <div
            className="absolute top-[65%] right-[18%] w-26 h-26 bg-gradient-to-br from-[#70BFFF]/22 to-[#BE55FF]/22 rounded-full animate-float-medium"
            style={{ animationDelay: "1.3s" }}
          />
          <div
          ...
          />
          <div
            className="absolute top-[15%] left-[65%] w-28 h-28 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-2xl rotate-45 animate-float-slow"
          ...
          />
          <div
            className="absolute bottom-[55%] right-[45%] w-30 h-30 bg-gradient-to-br from-[#BE55FF]/21 to-[#70BFFF]/21 rounded-full animate-float-fast"
            style={{ animationDelay: "1.7s" }}
          />
          <div
          ...
          />
          <div
            className="absolute top-[25%] right-[55%] w-22 h-22 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-2xl rotate-12 animate-float-medium"
            style={{ animationDelay: "1.4s" }}
          />
          <div
            className="absolute bottom-[38%] left-[50%] w-26 h-26 bg-[#BE55FF]/19 rounded-full animate-float-fast"
            style={{ animationDelay: "0.6s" }}
          />
          <div
            className="absolute top-[75%] right-[12%] w-20 h-20 bg-gradient-to-br from-[#70BFFF]/21 to-[#BE55FF]/21 rounded-xl rotate-45 animate-float-slow"
            style={{ animationDelay: "1.2s" }}
          />
        </div>
        <LandingPortfolio />
      ...
      <div className="bg-[#E6F2FF] relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute bottom-[30%] left-[15%] w-24 h-24 bg-gradient-to-br from-[#BE55FF]/25 to-[#70BFFF]/25 rounded-full animate-float-medium"
            style={{ animationDelay: "1.2s" }}
          />
          <div
            className="absolute top-[50%] right-[5%] w-18 h-18 bg-[#70BFFF]/20 rounded-lg rotate-12 animate-float-fast"
            style={{ animationDelay: "0.8s" }}
          />
          <div
            className="absolute bottom-[50%] left-[30%] w-22 h-22 bg-[#BE55FF]/22 rounded-2xl rotate-45 animate-float-slow"
            style={{ animationDelay: "1.6s" }}
          />
          <div
            className="absolute top-[75%] right-[30%] w-26 h-26 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-full animate-float-medium"
            style={{ animationDelay: "0.4s" }}
          />
          <div
            className="absolute top-[12%] left-[18%] w-20 h-20 bg-[#BE55FF]/18 rounded-xl rotate-12 animate-float-fast"
            style={{ animationDelay: "1.4s" }}
          />
          <div
            className="absolute bottom-[12%] right-[18%] w-30 h-30 bg-gradient-to-br from-[#70BFFF]/22 to-[#BE55FF]/22 rounded-full animate-float-slow"
            style={{ animationDelay: "0.6s" }}
          />
          <div
            className="absolute top-[40%] left-[5%] w-18 h-18 bg-[#70BFFF]/19 rounded-lg rotate-12 animate-float-medium"
            style={{ animationDelay: "0.3s" }}
          />
          <div
            className="absolute bottom-[40%] right-[40%] w-28 h-28 bg-gradient-to-br from-[#BE55FF]/21 to-[#70BFFF]/21 rounded-full animate-float-fast"
            style={{ animationDelay: "1.7s" }}
          />
          <div
            className="absolute top-[60%] left-[45%] w-24 h-24 bg-[#BE55FF]/18 rounded-xl rotate-45 animate-float-slow"
            style={{ animationDelay: "0.9s" }}
          />
          <div
            className="absolute top-[25%] right-[55%] w-22 h-22 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-2xl rotate-12 animate-float-medium"
          ...
          />
          <div
            className="absolute bottom-[65%] left-[60%] w-26 h-26 bg-[#BE55FF]/19 rounded-full animate-float-fast"
            style={{ animationDelay: "0.5s" }}
          />
          <div
            className="absolute top-[85%] right-[12%] w-20 h-20 bg-gradient-to-br from-[#70BFFF]/21 to-[#BE55FF]/21 rounded-xl rotate-45 animate-float-slow"
      ...
      <div className="bg-[#E6F2FF] relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute top-[10%] right-[22%] w-24 h-24 bg-gradient-to-br from-[#70BFFF]/25 to-[#BE55FF]/25 rounded-full animate-float-medium"
            style={{ animationDelay: "1.3s" }}
          />
          <div
            className="absolute top-[65%] left-[12%] w-20 h-20 bg-[#BE55FF]/20 rounded-lg rotate-12 animate-float-fast"
            style={{ animationDelay: "0.9s" }}
          />
          <div
            className="absolute bottom-[30%] right-[12%] w-26 h-26 bg-[#70BFFF]/22 rounded-2xl rotate-45 animate-float-slow"
            style={{ animationDelay: "1.7s" }}
          />
          <div
            className="absolute top-[30%] right-[65%] w-22 h-22 bg-gradient-to-br from-[#BE55FF]/20 to-[#70BFFF]/20 rounded-full animate-float-medium"
            style={{ animationDelay: "0.5s" }}
          />
          <div
            className="absolute bottom-[22%] left-[30%] w-24 h-24 bg-gradient-to-br from-[#BE55FF]/20 to-[#70BFFF]/20 rounded-2xl rotate-45 animate-float-fast"
            style={{ animationDelay: "1.1s" }}
          />
          <div
            className="absolute top-[50%] left-[50%] w-18 h-18 bg-[#70BFFF]/18 rounded-lg rotate-12 animate-float-slow"
            style={{ animationDelay: "0.7s" }}
          />
          <div
            className="absolute bottom-[18%] right-[30%] w-28 h-28 bg-gradient-to-br from-[#BE55FF]/22 to-[#70BFFF]/22 rounded-full animate-float-medium"
            style={{ animationDelay: "1.5s" }}
          />
          <div
            className="absolute top-[8%] left-[45%] w-20 h-20 bg-[#BE55FF]/19 rounded-lg rotate-12 animate-float-fast"
            style={{ animationDelay: "0.3s" }}
          />
          <div
            className="absolute bottom-[42%] right-[45%] w-30 h-30 bg-gradient-to-br from-[#70BFFF]/21 to-[#BE55FF]/21 rounded-full animate-float-slow"
            style={{ animationDelay: "1.2s" }}
          />
          <div
            className="absolute top-[35%] left-[8%] w-22 h-22 bg-[#BE55FF]/18 rounded-xl rotate-45 animate-float-medium"
            style={{ animationDelay: "0.8s" }}
          />
          <div
            className="absolute bottom-[8%] right-[55%] w-26 h-26 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-full animate-float-fast"
            style={{ animationDelay: "1.4s" }}
          />
          <div
            className="absolute top-[70%] right-[8%] w-24 h-24 bg-[#BE55FF]/19 rounded-xl rotate-12 animate-float-slow"
            style={{ animationDelay: "0.6s" }}
          />
        </div>
        <LandingServices />
      ...
      <div className="bg-[#E6F2FF] relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          {/* Geometric shapes - distributed with floating animations, spread out more */}
          <div
            className="absolute top-[22%] right-[22%] w-24 h-24 bg-gradient-to-br from-[#BE55FF]/25 to-[#70BFFF]/25 rounded-full animate-float-slow"
            style={{ animationDelay: "1.1s" }}
          />
          ...
          <div
            className="absolute bottom-[22%] left-[18%] w-24 h-24 bg-gradient-to-br from-[#BE55FF]/25 to-[#70BFFF]/25 rounded-full animate-float-fast"
            style={{ animationDelay: "1.1s" }}
          />
          <div
            className="absolute top-[65%] right-[30%] w-18 h-18 bg-[#70BFFF]/20 rounded-lg rotate-12 animate-float-slow"
            style={{ animationDelay: "0.7s" }}
          />
          <div
            className="absolute bottom-[50%] left-[65%] w-22 h-22 bg-[#BE55FF]/22 rounded-2xl rotate-45 animate-float-medium"
            style={{ animationDelay: "1.5s" }}
          />
          <div
            className="absolute top-[22%] left-[50%] w-26 h-26 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-full animate-float-fast"
            style={{ animationDelay: "0.3s" }}
          />
          <div
            className="absolute top-[8%] left-[30%] w-20 h-20 bg-[#BE55FF]/18 rounded-xl rotate-12 animate-float-slow"
            style={{ animationDelay: "1.8s" }}
          />
          <div
            className="absolute bottom-[12%] right-[12%] w-28 h-28 bg-gradient-to-br from-[#70BFFF]/22 to-[#BE55FF]/22 rounded-full animate-float-medium"
            style={{ animationDelay: "0.9s" }}
          />
          <div
            className="absolute top-[40%] left-[8%] w-18 h-18 bg-[#70BFFF]/19 rounded-lg rotate-12 animate-float-fast"
            style={{ animationDelay: "0.4s" }}
          />
          <div
            className="absolute bottom-[38%] right-[45%] w-30 h-30 bg-gradient-to-br from-[#BE55FF]/21 to-[#70BFFF]/21 rounded-full animate-float-slow"
            style={{ animationDelay: "1.6s" }}
          />
          <div
            className="absolute top-[55%] left-[45%] w-24 h-24 bg-[#BE55FF]/18 rounded-xl rotate-45 animate-float-medium"
            style={{ animationDelay: "1.2s" }}
          />
          <div
            className="absolute top-[35%] right-[55%] w-22 h-22 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-2xl rotate-12 animate-float-fast"
            style={{ animationDelay: "0.8s" }}
          />
          <div
            className="absolute bottom-[28%] left-[55%] w-26 h-26 bg-[#BE55FF]/19 rounded-full animate-float-slow"
            style={{ animationDelay: "1.4s" }}
          />
        </div>
        <LandingTestimonials />
      ...
      <div className="bg-[#E6F2FF] relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute bottom-[22%] right-[12%] w-24 h-24 bg-gradient-to-br from-[#70BFFF]/25 to-[#BE55FF]/25 rounded-full animate-float-medium"
            style={{ animationDelay: "1.4s" }}
          />
          <div
            className="absolute top-[50%] right-[50%] w-20 h-20 bg-[#BE55FF]/20 rounded-lg rotate-12 animate-float-fast"
            style={{ animationDelay: "0.6s" }}
          />
          <div
            className="absolute bottom-[50%] left-[50%] w-22 h-22 bg-[#70BFFF]/22 rounded-2xl rotate-45 animate-float-slow"
            style={{ animationDelay: "1.8s" }}
          />
          <div
            className="absolute top-[75%] right-[22%] w-26 h-26 bg-gradient-to-br from-[#BE55FF]/20 to-[#70BFFF]/20 rounded-full animate-float-medium"
            style={{ animationDelay: "0.2s" }}
          />
          <div
            className="absolute top-[12%] left-[30%] w-18 h-18 bg-[#70BFFF]/18 rounded-lg rotate-12 animate-float-fast"
            style={{ animationDelay: "1.2s" }}
          />
          <div
            className="absolute bottom-[12%] right-[22%] w-30 h-30 bg-gradient-to-br from-[#BE55FF]/22 to-[#70BFFF]/22 rounded-full animate-float-slow"
            style={{ animationDelay: "0.4s" }}
          />
          <div
            className="absolute top-[35%] left-[8%] w-20 h-20 bg-[#BE55FF]/19 rounded-lg rotate-12 animate-float-medium"
            style={{ animationDelay: "0.3s" }}
          />
          <div
            className="absolute bottom-[38%] right-[38%] w-28 h-28 bg-gradient-to-br from-[#70BFFF]/21 to-[#BE55FF]/21 rounded-full animate-float-fast"
            style={{ animationDelay: "1.6s" }}
          />
          <div
            className="absolute top-[60%] left-[55%] w-24 h-24 bg-[#BE55FF]/18 rounded-xl rotate-45 animate-float-slow"
            style={{ animationDelay: "1.1s" }}
          />
          <div
            className="absolute top-[28%] right-[60%] w-22 h-22 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-2xl rotate-12 animate-float-medium"
            style={{ animationDelay: "0.8s" }}
          />
          <div
            className="absolute bottom-[28%] left-[60%] w-26 h-26 bg-[#BE55FF]/19 rounded-full animate-float-fast"
            style={{ animationDelay: "1.5s" }}
          />
          <div
            className="absolute top-[80%] right-[8%] w-20 h-20 bg-gradient-to-br from-[#70BFFF]/21 to-[#BE55FF]/21 rounded-xl rotate-45 animate-float-slow"
            style={{ animationDelay: "0.9s" }}
          />
        </div>
        <LandingBrands />
