          ...
          <div className="relative">
            ...
            <div className="relative">
              <div className="flex items-center justify-center mb-6">
                <Image src="/images/youu-clean-logo.png" alt="Youu Media" width={80} height={80} className="w-20 h-20" />
              </div>
        ...
        <div className="relative p-[9px] rounded-lg overflow-hidden border-glow">
          ...
          <Card className="border-0 shadow-lg relative bg-white">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Tell us about yourself and your creative expertise. We'll review
          ...
          <Card className="border-border/50">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                ...
                information and portfolio. If you're a good fit, we'll reach out
                within 5-7 business days to discuss potential opportunities and
                next steps in joining our creative network.
              </p>
            </CardContent>
          </Card>
        </div>
