...
const categories = ["All", "Event Videography", "Brand Content", "Corporate", "Photography"]
...
const portfolioItems = [
  ...
  },
  {
    ...
    thumbnail: "/corporate-office-cinematic-video-thumbnail.jpg",
    description: "Food photography and restaurant ambiance shots for social media and marketing materials.",
  ...
  },
  {
    ...
    duration: "12:45",
    thumbnail: "/elegant-wedding-ceremony-cinematic-video-thumbnail.jpg",
    description: "Multi-part training video series with professional interviews and instructional content.",
                  ...
                  >
                    ...
                    <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
                      ...
                      <div className="absolute top-4 left-4">
                        <Badge className="bg-gradient-to-r from-[#BE55FF] to-[#70BFFF] text-white px-4 py-2 text-sm shadow-xl">Featured</Badge>
                      </div>
                    </div>
                    ...
                    <CardContent className="p-8 relative z-10">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <p className="text-gray-600 font-medium">{item.client}</p>
                        </div>
                      ...
                      <p className="text-gray-700 mb-6 text-pretty leading-relaxed">{item.description}</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {regularItems.map((item, index) => {
            ...
            return (
              <Card
                key={item.id}
                className={`group overflow-hidden hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-gradient-to-r hover:from-[#BE55FF] hover:to-[#70BFFF] ${portfolioGradients[index % 4]} relative`}
              >
                {/* Decorative background pattern */}
                <div className="absolute inset-0 opacity-10 z-0">
                ...
                <CardContent className="p-6 relative z-10">
                  <h3 className="text-xl font-bold mb-2 group-hover:bg-gradient-to-r group-hover:from-[#BE55FF] group-hover:to-[#70BFFF] group-hover:bg-clip-text group-hover:text-transparent transition-colors bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">{item.title}</h3>
                  <p className="text-gray-600 font-medium mb-3">{item.client}</p>
                  <p className="text-gray-700 text-sm text-pretty leading-relaxed">{item.description}</p>
                </CardContent>
              </Card>
            );
          })}
