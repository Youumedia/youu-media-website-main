...
const stats = [
  {
    ...
    description: "Successful deliveries across events, brands, and corporate storytelling",
  },
  {
    number: "15+",
    label: "Skilled Freelancers",
    description: "Professional videographers, photographers, and editors in our network",
  },
  {
    number: "100%",
    label: "Client Satisfaction",
    description: "Consistent quality and professional delivery on every project",
  },
  {
    number: "24/7",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-balance text-gray-900">
            Trusted by <span className="bg-gradient-to-r from-[#BE55FF] to-[#70BFFF] bg-clip-text text-transparent">Clients Worldwide</span>
          </h2>
          <p className="mt-4 text-lg text-gray-700 max-w-2xl mx-auto text-pretty">
            Our commitment to excellence and professional delivery has earned us the trust of brands and individuals
            alike.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <CardContent className="p-8 relative z-10">
                  ...
                  <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">{stat.label}</h3>
                  <p className="text-base text-gray-700 text-pretty leading-relaxed">{stat.description}</p>
                </CardContent>
              </Card>
            );
          })}
