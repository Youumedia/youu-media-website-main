  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-br from-[#70BFFF]/10 via-white to-[#BE55FF]/10" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#70BFFF]/5 via-transparent to-[#BE55FF]/5 animate-gradient-x" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(112,191,255,0.15),transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(190,85,255,0.15),transparent_50%)]" />
      </div>

      {/* Creative geometric shapes */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Large floating orbs */}
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#70BFFF]/12 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[#BE55FF]/12 rounded-full blur-3xl animate-float-medium" />
        <div className="absolute top-1/2 left-1/2 w-[300px] h-[300px] bg-[#70BFFF]/10 rounded-full blur-2xl animate-float-fast" />

        {/* Geometric shapes */}
        <div className="absolute top-20 right-20 w-32 h-32 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-3xl rotate-45 animate-pulse" />
        <div
          className="absolute bottom-32 left-32 w-24 h-24 bg-gradient-to-br from-[#BE55FF]/20 to-[#70BFFF]/20 rounded-full animate-pulse"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute top-1/3 right-1/3 w-16 h-16 bg-[#70BFFF]/15 rounded-lg rotate-12 animate-pulse"
      ...
      <div className="absolute inset-0 opacity-[0.04]">
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(112, 191, 255, 0.4) 1px, transparent 1px),
                              linear-gradient(90deg, rgba(112, 191, 255, 0.4) 1px, transparent 1px)`,
