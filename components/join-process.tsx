...
const steps = [
  {
    ...
    description:
      "Share your portfolio, experience, and tell us about your creative vision and goals.",
    action: "Apply Now",
  },
  {
    icon: MessageCircle,
    ...
    description:
      "Quick chat to understand your skills, availability, and how you fit with our team culture.",
  ...
  },
  {
    ...
    description:
      "Our team reviews your work to ensure it meets our quality standards and client expectations.",
    action: "Under Review",
  },
  {
    icon: Handshake,
    ...
    description:
      "Get onboarded, access our project management system, and start receiving opportunities.",
...
export function JoinProcess() {
  return (
    <section id="join-process" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Our application process is designed to find passionate creatives who
            share our vision for quality work.
          </p>
        </div>
              ...
              >
                <CardContent className="p-8 text-center relative">
                  ...
                  <div className="absolute inset-0 opacity-20">
                    <div
                      className={`absolute top-6 right-6 w-16 h-16 bg-gradient-to-br ${processStyles[index].glow} rounded-full blur-lg`}
                    ></div>
                    <div
                      className={`absolute bottom-6 left-6 w-12 h-12 bg-gradient-to-tr ${processStyles[index].glow} rounded-full blur-md`}
                    ></div>
                  </div>

                  <div
                    className={`absolute -top-6 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-gradient-to-r ${processStyles[index].number} rounded-full flex items-center justify-center text-white text-lg font-bold shadow-xl`}
                  >
                    {index + 1}
                  </div>

                  <div
                    className={`w-20 h-20 bg-gradient-to-br ${processStyles[index].glow} rounded-2xl flex items-center justify-center mx-auto mb-6 mt-6 group-hover:scale-110 transition-transform shadow-lg relative`}
                  >
                    <step.icon className="h-10 w-10 text-white" />
                    {/* Icon glow */}
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${processStyles[index].glow} rounded-2xl blur-md opacity-60 group-hover:opacity-80 transition-opacity`}
                    ></div>
                  </div>
                  ...
                  <p className="text-gray-700 text-sm text-pretty mb-6 leading-relaxed">
                    {step.description}
                  </p>
        ...
        <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 md:p-12 text-center text-white">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto text-pretty">
            If this vision excites you and you want to be part of a growing
            creative network, let's create something powerful together.
          </p>
