...
import { Video, Camera, Edit3, Mic, Bone as Drone, Palette } from "lucide-react"
...
const services = [
  {
    ...
    description: "Capture your special moments with cinematic quality and professional consistency.",
    features: [
  ...
  },
  {
    ...
    description: "Professional photography that brings your brand and products to life.",
    features: [
  ...
  },
  {
    ...
    description: "Transform raw footage into compelling stories with professional polish.",
    features: [
  ...
  },
  {
    ...
    description: "Stunning aerial footage that adds cinematic scope to your project.",
    features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Comprehensive creative services designed to meet all your visual storytelling needs.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card
              key={index}
              className={`group hover:shadow-lg transition-all duration-300 border-border/50 hover:border-primary/50 bg-blue-100 ${service.popular ? "ring-2 ring-primary/20" : ""}`}
            >
              {service.popular && (
