...
export function LandingTestimonials() {
  ...
  return (
    ...
    >
      {/* Creative floating orbs and shapes - unique distribution for Testimonials section */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Large floating orbs - positioned differently */}
        <div className="absolute top-1/5 right-1/4 w-[430px] h-[430px] bg-[#70BFFF]/18 rounded-full blur-3xl animate-float-medium" />
        <div className="absolute bottom-1/5 left-1/3 w-[450px] h-[450px] bg-[#BE55FF]/20 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute top-1/2 right-0 w-[380px] h-[380px] bg-[#70BFFF]/15 rounded-full blur-2xl animate-float-fast" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#BE55FF]/17 rounded-full blur-3xl animate-float-medium" />

        {/* Geometric shapes - spread around */}
        <div className="absolute top-1/4 left-1/6 w-26 h-26 bg-gradient-to-br from-[#70BFFF]/25 to-[#BE55FF]/25 rounded-full animate-pulse" style={{ animationDelay: "0.5s" }} />
        <div className="absolute bottom-1/3 right-1/4 w-22 h-22 bg-gradient-to-br from-[#BE55FF]/25 to-[#70BFFF]/25 rounded-3xl rotate-45 animate-pulse" style={{ animationDelay: "1.3s" }} />
        <div className="absolute top-2/3 left-1/2 w-18 h-18 bg-[#70BFFF]/20 rounded-lg rotate-12 animate-pulse" style={{ animationDelay: "0.9s" }} />
        <div className="absolute bottom-1/4 right-1/6 w-30 h-30 bg-gradient-to-br from-[#BE55FF]/22 to-[#70BFFF]/22 rounded-2xl animate-pulse" style={{ animationDelay: "1.8s" }} />
      </div>
