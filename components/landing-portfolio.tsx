...
export function LandingPortfolio() {
  ...
  return (
    ...
    >
      {/* Creative floating orbs and shapes - unique distribution for Portfolio section */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Large floating orbs - positioned differently */}
        <div className="absolute top-0 left-1/4 w-[440px] h-[440px] bg-[#BE55FF]/19 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute bottom-1/3 right-1/5 w-[410px] h-[410px] bg-[#70BFFF]/17 rounded-full blur-3xl animate-float-medium" />
        <div className="absolute top-3/4 left-1/2 w-[370px] h-[370px] bg-[#BE55FF]/16 rounded-full blur-2xl animate-float-fast" />
        <div className="absolute bottom-0 right-1/2 w-[400px] h-[400px] bg-[#70BFFF]/18 rounded-full blur-3xl animate-float-slow" />

        {/* Geometric shapes - spread around */}
        <div className="absolute top-1/5 right-1/5 w-30 h-30 bg-gradient-to-br from-[#BE55FF]/25 to-[#70BFFF]/25 rounded-2xl rotate-45 animate-pulse" style={{ animationDelay: "0.4s" }} />
        <div className="absolute bottom-1/5 left-1/4 w-24 h-24 bg-gradient-to-br from-[#70BFFF]/25 to-[#BE55FF]/25 rounded-full animate-pulse" style={{ animationDelay: "1.1s" }} />
        <div className="absolute top-1/2 right-1/6 w-20 h-20 bg-[#BE55FF]/22 rounded-lg rotate-12 animate-pulse" style={{ animationDelay: "0.7s" }} />
        <div className="absolute bottom-2/3 left-1/6 w-28 h-28 bg-gradient-to-br from-[#70BFFF]/20 to-[#BE55FF]/20 rounded-3xl animate-pulse" style={{ animationDelay: "1.6s" }} />
      </div>
