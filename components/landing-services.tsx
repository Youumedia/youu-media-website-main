...
export function LandingServices() {
  return (
    ...
    >
      {/* Creative floating orbs and shapes - unique distribution for Services section */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Large floating orbs - positioned differently */}
        <div className="absolute top-1/6 left-1/2 w-[420px] h-[420px] bg-[#70BFFF]/19 rounded-full blur-3xl animate-float-medium" />
        <div className="absolute bottom-1/6 right-0 w-[480px] h-[480px] bg-[#BE55FF]/17 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute top-1/2 left-0 w-[360px] h-[360px] bg-[#70BFFF]/16 rounded-full blur-2xl animate-float-fast" />
        <div className="absolute bottom-0 right-1/4 w-[390px] h-[390px] bg-[#BE55FF]/18 rounded-full blur-3xl animate-float-medium" />

        {/* Geometric shapes - spread around */}
        <div className="absolute top-1/3 left-1/4 w-26 h-26 bg-gradient-to-br from-[#70BFFF]/25 to-[#BE55FF]/25 rounded-full animate-pulse" style={{ animationDelay: "0.6s" }} />
        <div className="absolute bottom-1/4 right-1/3 w-22 h-22 bg-gradient-to-br from-[#BE55FF]/25 to-[#70BFFF]/25 rounded-3xl rotate-45 animate-pulse" style={{ animationDelay: "1.4s" }} />
        <div className="absolute top-2/3 left-1/3 w-18 h-18 bg-[#70BFFF]/20 rounded-lg rotate-12 animate-pulse" style={{ animationDelay: "0.9s" }} />
        <div className="absolute bottom-1/2 right-1/6 w-30 h-30 bg-gradient-to-br from-[#BE55FF]/22 to-[#70BFFF]/22 rounded-2xl animate-pulse" style={{ animationDelay: "1.7s" }} />
      </div>
