...
COMMENT ON COLUMN public.FreelancerApplications.uploaded_files IS 'JSON string containing array of file objects with name, size, type, and lastModified properties';
